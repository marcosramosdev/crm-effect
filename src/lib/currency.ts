...
/**
 * App-wide fallback when no account/deal currency is available, and the
 * default a new account is born with (see migration 053 — existing
 * accounts keep whatever currency they already hold).
 */
