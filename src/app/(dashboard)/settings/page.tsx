...
import { MessagingPanel } from "@/components/settings/messaging-panel";
...
// (deep links such as `?tab=members`) and can't navigate away. Mirror
// the login/signup split: a thin wrapper supplies
