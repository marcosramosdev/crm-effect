...
import { LogOut, Menu, PlugZap, User } from "lucide-react";
import { ConnectionDot } from "@/components/layout/connection-indicator";
  ...
  return (
    <header className="border-border bg-background flex h-14 shrink-0 items-center justify-between gap-3 border-b px-4 lg:px-6">
      <div className="flex min-w-0 items-center gap-2">
        ...
        {/* Persisted WhatsApp status. The sidebar logo mark carries the
            same cue on lg+, where the sidebar is always visible. */}
        <ConnectionDot className="lg:hidden" />
      </div>
