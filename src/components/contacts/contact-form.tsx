...
interface ContactFormProps {
  ...
  onSaved: () => void;
  /** Fired after a successful CREATE (not edit) with the new contact's
   *  id — the contacts page uses it for the "message now" hand-off. */
...
export function ContactForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      onOpenChange(false);
      onSaved();
      if (!isEdit && contactId) onCreated?.(contactId);
    } catch (err: unknown) {
