...
> "Draft and send an order-update message to Jane."
...
| `send_message`       | write     | `messages:send`      | Send a WhatsApp message (text/media)              |
...
| `send_broadcast`     | broadcast | `broadcasts:send`    | Launch a free-form broadcast (requires `confirm`) |
